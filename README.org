...
There are two functions here, the first, bound to =SPC oop= runs the publishing
and =SPC ooP= runs the publishing and opens the magit buffer to commit and push
the changes.
