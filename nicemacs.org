#+title: NICEMACS
#+Time-stamp: <Last modified: 2022-09-10 10:15:29>
#+startup: overview
#+OPTIONS: toc:nil
#+OPTIONS: num:nil
...
in the mark-ring (a variable that holds locations in a buffer). Use
=evil-previous-mark= which is bound to =[ `= to navigate through the marks in
the mark-ring.
