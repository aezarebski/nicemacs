#+title: NICEMACS
#+Time-stamp: <Last modified: 2022-07-17 22:45:17>
#+startup: overview
#+OPTIONS: toc:nil
#+OPTIONS: num:nil
...
- Web-mode seems to be the default used by spacemacs, but this struggles with
  BEAST XML at times, the =nxml-mode= seems to be sufficient for this though.
