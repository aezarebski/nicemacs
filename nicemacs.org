#+title: NICEMACS
#+Time-stamp: <Last modified: 2022-09-02 11:12:14>
...
#+begin_src emacs-lisp
(defvar nicemacs-resources "~/Documents/nicemacs/resources"
  "The path to nicemacs on my machine.")

(defvar nicemacs-d3-files (list "d3.js" "demo.js" "demo.org" "index.html"
                                "blah.csv")
  "Useful files for starting a D3 project.")

(make-directory "~/sandbox4/d3-demo")
(mapc (lambda (x)
        (copy-file (concat nicemacs-resources "/d3-template/"
                           x)
                   (concat "~/sandbox4/d3-demo/" x)))
      nicemacs-d3-files)
#+end_src
