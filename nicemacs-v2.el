...
(defun nice-page-up ()
  "Scroll up by one page with smooth interpolation when available."
  (interactive)
  (if (fboundp 'pixel-scroll-interpolate-up)
      (pixel-scroll-interpolate-up)
    (scroll-down-command)))

(defun nice-page-down ()
  "Scroll down by one page with smooth interpolation when available."
  (interactive)
...
(setq bookmark-alist
	...
	("presentations" (filename . "~/Documents/presentations/"))
        ...
        ("website - notes - trials" (filename . "~/public-site/org/notes/trials-notes.org"))
